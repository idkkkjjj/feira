...
function mostrarTelaFinal() {
    document.body.innerHTML = `
        <div style="
            ...
            padding: 20px;
        ">
            <img src="fim.png" alt="Fim!" style="max-width: 50%; height: auto; margin-bottom: 30px;">
...
function mostrarTelaFalha() {
    document.body.innerHTML = `
        <div style="
            ...
            padding: 20px;
        ">
            <img src="errou.png" alt="Errou!" style="max-width: 50%; height: auto; margin-bottom: 30px;">
